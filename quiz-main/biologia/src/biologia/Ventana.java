    ...
    void enlace(String valor) {
        ...
        switch (opcinepreguntas) {
            case "0" ->     //pregunta                opcion1    1                opcion2       2           opcion3 3  opcion4 4
                this.opcion("La infertilidad es...", "la imposibilidad de procrear", "que no germine la planta", "el suelo", "otro");
            case "1" ->
                this.opcion("La andropausia es...", "cuando no hay embarazo", "el proceso en el que las capacidades disminuyen", "todas son correctas", "otro");
            case "2" ->
                this.opcion("¿Cuál de las siguientes opciones no es una causa de la andropausia?", "Falta de actividad sexual", "Niveles bajos de testosterona ", "Factores hereditarios", "Deficiencias hormonales");
            case "3" ->
                this.opcion("La andropausia se da en...", "niños", "mujeres", "hombres", "todos");
            case "4" ->
                this.opcion("¿A qué edad se presenta mayormente la infertilidad masculina?", "40 años", "10 años", "50 años", "30 años");
            case "5" ->
                this.opcion("¿A qué edad se presenta mayormente la infertilidad femenina?", "20-40 años", "40 años", "60 años", "45-51 años");
            case "6" ->
                this.opcion("¿Que causa la andropausia?","Comer mucho", "Incapacidad para procrear", " Los bajos niveles de testosterona en el cuerpo", "ninguno");
            case "7" ->
                this.opcion("¿La andropausia es un proceso natural ? ", "Si", "No", "", "");
            case "8" ->
                this.opcion("¿Cuál de estas es una causa de la infertilidad femenina?", "Factores hereditarios", "Falta de actividad sexual", "Alteraciones de la ovulación", "Ninguna");
            case "9"->
